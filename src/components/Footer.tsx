        ...
        <div className="grid md:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-2 text-gray-300 text-sm">
              ...
              <div className="flex justify-between min-w-[140px]">
                <span>Thurs:</span>
                <span className="font-medium">{COMPANY_INFO.hours.thursday}</span>
              </div>
              <div className="flex justify-between min-w-[140px]">
                <span>Fri - Sat:</span>
                <span className="font-medium">{COMPANY_INFO.hours.friday}</span>
              </div>
              <div className="flex justify-between min-w-[140px]">
                <span>Sunday:</span>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="/contact" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors">
